...
Característica: Usuario podra agregar o modificar requerimientos
  ...
  Escenario: usuario agrega o modifica requerimient
    ...
    Dado agregar numero requerimiento "1" y dependencia "000100"
    ...
    Dado dar clic en el botón "editar"
    Cuando Revisiones
    Entonces agregamos area "Planeación" y conceptos "Duracion estimada"
    ...
    Dado dar clic en el botón "aceptar"
    Cuando dar clic en el botón "cancelarModi"
    Entonces cerrar sesion

    Dado ingresa las credenciales email "userwapi02@saludcapital.gov.co" y contrasena "112233"
    Cuando podra dirigirse a la pantalla "Modificaciones solicitadas"
    Entonces Se filtras "estado" "En Revisi" "codigo proyecto" "7750"

    Dado dar clic en el botón "solicitud modificacion"
    Cuando dar clic en el botón "editar"
    Entonces dar clic en el botón "cancelar"

    Dado dar clic en el botón "enviar revisiones"
    Cuando ingresar un comentario para la revision "Prueba"
    Entonces dar clic en el botón "Rechazar"